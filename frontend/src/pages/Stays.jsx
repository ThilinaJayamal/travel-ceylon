...
const Stays = () => {
    ...
    // Dummy function instead of Zustand's toggleReviewOpen
    const toggleReviewOpen = () => {
        console.log("Review modal toggled (dummy handler)");
    };
    ...
    return (
        <div className="overflow-auto m-auto ">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 px-6 md:px-10  bg-white max-w-[88%] rounded-lg shadow-md m-auto max-h-auto mb-10">
            ...
            <div className="flex flex-col max-w-[88%] m-auto mb-10">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 grid-cols-1 lg:gap-10 space-x-4">
                    {asserts.staysOffers.map((staysOffers, index) => (
                        <div
                            key={index}
                            className="flex flex-col items-center mb-6 p-4 bg-green-200 bg-opacity-25 hover:bg-green-300 shadow-1xl rounded-2xl transform motion-safe:hover:scale-105 "
                        >
                            <img
                                src={staysOffers.image}
                                alt={staysOffers.heading}
                            ...
                            <div className="text-center md:max-w-[200px] mb-10">
                                ...
                                <p className="text-gray-500">{staysOffers.description}</p>
                            </div>
                        </div>
                    ))}
                </div>
