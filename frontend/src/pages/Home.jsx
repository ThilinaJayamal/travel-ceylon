          ...
          <div className="mt-20 grid lg:grid-cols-[2.5fr_2fr] gap-4 grid-cols-1">
            <div className="p-4 flex flex-col justify-center items-start">
              ...
              <p className="text-xl mt-6 text-black/70">
                ...
                helps you find the best destinations, book hassle-free trips,
                and discover must-visit places with ease. Whether you're
                planning your next adventure or need assistance with vehicle
                rentals, route navigation, or nearby facilities, we've got you
                covered.
              </p>
          ...
          <div className="mt-12">
            <div className="p-4 w-full">
              ...
              <div className="flex justify-end items-center">
                <button className="px-4 py-2 rounded-md border-2 border-green-300 cursor-pointer">
                  Add Review
                </button>
              </div>
            </div>
