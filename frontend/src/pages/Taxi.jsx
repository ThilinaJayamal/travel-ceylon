    ...
    <div className="w-full">
      ...
      <div className="xl:mx-12 mx-4 mb-16 p-8 mt-12 grid lg:grid-cols-[2.5fr_2fr] gap-4 grid-cols-1 bg-white rounded-4xl">
        <div className="p-4 flex flex-col justify-start items-start">
          ...
          <p className="text-xl mt-4 text-black/90">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 bg-white xl:mx-12 mx-4 mb-16 rounded-xl mt-12 border border-gray-200">
        <div className="pt-4">
          <img
            src={asserts.taxibtm}
            className="max-w-full max-h-[400px] lg:rounded-[0px] rounded-b-full mx-auto"
            alt=""
          />
        </div>
        <div className="p-8">
          ...
          <button className="mt-6 px-8 py-2 rounded-full bg-green-200 text-lg cursor-pointer hover:bg-green-300">
            List your Vehicle
          </button>
        </div>
      </div>
