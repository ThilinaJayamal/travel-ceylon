...
const DestinationFilter = ({ onSearch }) => {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-6xl mx-auto -mt-12 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-4 gap-7">
        {/* Destination */}
        <div className="relative">
          <label className="block text-sm font-medium text-gray-700 mb-1">
            Destination
          </label>
          <div className="flex items-center border rounded px-3 py-2 md:col-auto-1">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="px-2 rounded lg:m-2"
                  >
                    <FaRegSquareMinus className="md:text-1xl lg:text-2xl" />
                  </button>
                  <span>{rooms}</span>
                  <button
                  ...
                  >
                    <FaRegSquarePlus className="md:text-1xl lg:text-2xl" />
                  </button>
                </div>
              </div>
              {/* Guest Selector */}
        ...
        {/* Search Button */}
        <div className="flex items-end justify-end col-span-full mt-4 md:mt-0">
          <button
